...
from .upload_resume import resume_upload_router
from .resume_analysis import resume_analysis_router
...
api_router.include_router(resume_upload_router, prefix="/chat/upload-resume")
api_router.include_router(resume_analysis_router, prefix="/chat/resume")
